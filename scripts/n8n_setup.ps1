...
Write-Host "3. Workflows > Import from File:" -ForegroundColor Gray
Write-Host "   $ProjectPath\n8n\rac_coleta_monitor.json" -ForegroundColor Gray
Write-Host "4. No no 'Coleta Pronta', ajuste o campo path para:" -ForegroundColor Gray
Write-Host "   $outDir" -ForegroundColor Gray
Write-Host "5. No no 'Upload CSV', confirme que o caminho do projeto" -ForegroundColor Gray
Write-Host "   bate com: $ProjectPath" -ForegroundColor Gray
