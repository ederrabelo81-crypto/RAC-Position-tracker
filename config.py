...
USER_AGENTS: List[str] = [
    # Apenas UAs Chromium (Chrome/Edge): `BaseScraper._launch()` só lança
    # engines Chromium reais (channel "chrome" -> "msedge" -> chromium puro),
    # nunca Firefox. Um UA Firefox sorteado aqui produz um fingerprint
    # inconsistente (TLS/JS de Chromium + navigator.userAgent de Firefox) —
    # sinal clássico de bot detection que derrubou a coleta do Mercado Livre
    # (login gate em quase 100% das keywords) até jul/2026.
